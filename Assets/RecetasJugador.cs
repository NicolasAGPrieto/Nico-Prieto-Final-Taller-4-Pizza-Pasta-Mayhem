        ...
        if ((TengoPan == 1) && (TengoPaty == 1) && (TengoQueso == 1))
        {
            if (ActiveReceta1 == 0)
            {
                ...
                */
                ...
                CustomEvent activarP1 = new CustomEvent("activar_powerup_1")
               
            {
                ...
                AnalyticsService.Instance.RecordEvent(activarP1);
    ...
    public void Receta2Activada()
    {
        if ((TengoJamon == 1) && (TengoSalchicha == 1) && (TengoAlbondigas == 1))
        {
            if (ActiveReceta2 == 0)
            {
                ...
                CustomEvent activarP2 = new CustomEvent("activar_powerup_2")
                ...
                AnalyticsService.Instance.RecordEvent(activarP2);
                AnalyticsService.Instance.Flush();
    ...
    public void Receta3Activada()
    {
        if ((TengoPollo == 1) && (TengoLechuga == 1) && (TengoTomate == 1))
        {
            if (ActiveReceta3 == 0)
            {
                ...
                CustomEvent activarP3 = new CustomEvent("activar_powerup_3")
               
            {
                ...
                AnalyticsService.Instance.RecordEvent(activarP3);
                AnalyticsService.Instance.Flush();
