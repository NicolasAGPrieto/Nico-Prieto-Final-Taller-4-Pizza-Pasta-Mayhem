...
public class JugadorControl : MonoBehaviour
{
    ...
    public void PowerAnalytic()
    {
        ...
        */
        ...
        CustomEvent usarpowerup = new CustomEvent(nombreanalytics)
        ...
        AnalyticsService.Instance.RecordEvent(usarpowerup);
    ...
    public void Limbo()
    {
        ...
        if(estado == GameState.muerto)
        {
            ...
            CustomEvent mortis = new CustomEvent("morir")
            ...
            AnalyticsService.Instance.RecordEvent(mortis);
    ...
    public void SwitchMorirAnalytics()
    {
        ...
        switch(Nivel)
        {
            ...
            { { "enemy", EnemigoAsesino }, { "ammo", municionActual } }
            ...
            { { "enemy", EnemigoAsesino }, { "ammo", municionActual } }
                ...
                break;
            case 7:
                CustomEvent mortis7 = new CustomEvent("morir7")
               
            { { "enemy", EnemigoAsesino }, { "ammo", municionActual } }


;
                AnalyticsService.Instance.RecordEvent(mortis7);
                break;
            case 8:
                CustomEvent mortis8 = new CustomEvent("morir8")
...
;
                AnalyticsService.Instance.RecordEvent(mortis8);
                break;
            case 9:
            ...
            { { "enemy", EnemigoAsesino }, { "ammo", municionActual } }
                ...
                break;
            case 12:
                CustomEvent mortis12 = new CustomEvent("morir12")
              
            { { "enemy", EnemigoAsesino }, { "ammo", municionActual } }


;
                AnalyticsService.Instance.RecordEvent(mortis12);
                break;
            case 13:
